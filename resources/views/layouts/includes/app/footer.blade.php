<footer class="bg-neutral-primary-soft dark:text-white">
    <div class="mx-auto max-w-7xl p-4 py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    ...
                    <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">CodegersTec</span>
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-body sm:text-center">© {{ now()->format('Y') }} <a href="/"
                    class="hover:underline">CodegersTec™</a>. Todos los derechos reservados.
            </span>
